                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-24">
                    ...
                    <div className="flex-1 text-center px-4">
                        <span className="text-sm">
                            You're viewing <strong>static sample content</strong> - not AI generated.<br />
                            <span className="hidden sm:inline">Configure your API key to enable real AI story generation.</span>
                        </span>
                    </div>
                    {onOpenSettings && (
                        <Button
